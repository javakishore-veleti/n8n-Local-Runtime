...
|------|-------------------|------|
| `INSTRUCTIONS-Generate-Architecture-Diagrams.md` | Single HTML file with 9 interactive architecture diagrams | ~1 file |
...
- If the output is too long for a single response, ask Claude to generate diagrams 1-5 first, then 6-9
...
```
SkillForge-Architecture-Diagrams.html    (single interactive HTML, ~2000 lines)
```
